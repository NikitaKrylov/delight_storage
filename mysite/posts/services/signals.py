...
#     if (
#         created
#         and instance.answered
#         and instance.answered.author.settings.notify_on_comment_reply
#     ):
#         send_notifications.delay(
#             sender_id=instance.author.id,
...
#     elif (
#         created
#         and not instance.answered
#         and instance.post.author.settings.notify_on_post_commented
#     ):
#         send_notifications.delay(
#             sender_id=instance.author.id,
